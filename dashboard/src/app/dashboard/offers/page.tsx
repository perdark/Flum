    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 rounded-xl p-5 border border-blue-500/20">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-primary text-sm font-medium">Total Offers</p>
              <p className="text-3xl font-bold text-foreground mt-1">{offers.length}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-amber-500/10 to-orange-600/5 rounded-xl p-5 border border-amber-500/20">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-brand text-sm font-medium">Hero Offers</p>
              <p className="text-3xl font-bold text-foreground mt-1">{heroCount}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-slate-500/10 to-slate-600/5 rounded-xl p-5 border border-slate-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-foreground mt-1">{expiredCount}</p>
            </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-muted border border-input rounded-lg text-foreground placeholder:text-muted-foreground focus:border-ring focus:ring-2 focus:ring-ring transition-colors"
          />
        </div>
            ...
            <button
              ...
              className={cn(
                ...
                filter === filterType
                  ...
                  : 'bg-card text-foreground hover:bg-muted border border-input'
              )}
            >
      ...
      {filteredOffers.length === 0 ? (
        <div className="text-center py-16">
          ...
          {!search && (
            <Link href="/dashboard/offers/new">
              <button className="px-6 py-2.5 bg-brand text-brand-foreground rounded-lg hover:bg-amber-600 transition-colors font-medium">
                Create Offer
              </button>
            </Link>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredOffers.map((offer, index) => {
            ...
            const displayTypeColors = {
              ...
              banner: 'bg-primary/10 text-primary border-primary/30',
            ...
            return (
              <div
                key={offer.id}
                className="bg-card rounded-xl border border-border overflow-hidden hover:border-input transition-colors group"
              >
                {/* Color bar */}
                <div
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2 pt-3 border-t border-border">
                    <Link
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-secondary text-foreground rounded-lg hover:bg-secondary transition-colors text-sm font-medium"
                    >
